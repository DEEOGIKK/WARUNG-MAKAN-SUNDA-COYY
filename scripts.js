...
function dheaOnC() {
    alert("DEA YANG NGELUH BUG DIAMNA MANA")
    alert("ERROR CODE DI LINE 140... MEANWHILE LINE 140 : (LINE KOSONG)")
}
function ogikOnC() {
    alert("OGIK YANG STRES NYARI KODE YANG NGEBUG")
    alert("ITU BUKAN BUG TAPI ITU FITURRRR")
}

//CODE VER 13.3.2024r001